...
case CREDITS_CHAR_CYRILLIC_DE:
	...
	print_credits_char(curX, (curY + 8), CREDITS_CHAR_UNDERSYM_LEFT);
	print_credits_char(curX, (curY + 8), CREDITS_CHAR_UNDERSYM_RIGHT);
	curX += 7;
	break;
case CREDITS_CHAR_CYRILLIC_I_SHORT:
	print_credits_char(curX, curY, CREDITS_CHAR_CYRILLIC_I);
	print_credits_char(curX, (curY - 8), CREDITS_CHAR_CYRILLIC_I_SHORT);
	curX += 7;
	break;
...
case CREDITS_CHAR_CYRILLIC_IO:
	...
	print_credits_char(curX, (curY - 8), CREDITS_CHAR_CYRILLIC_IO);
	curX += 7;
	break;
