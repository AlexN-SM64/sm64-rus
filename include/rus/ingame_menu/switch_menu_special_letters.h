...
case DIALOG_CHAR_CYRILLIC_CAPITAL_DE: // Д
	...
	print_menu_char(curX, (curY + 8), MENU_CHAR_UNDERSYM_LEFT);
	print_menu_char((curX + gDialogCharWidths[str[strPos]] - 8), (curY + 8), MENU_CHAR_UNDERSYM_RIGHT);
...
case DIALOG_CHAR_CYRILLIC_CAPITAL_I_SHORT: // Й
	...
	print_menu_char(curX, (curY - 8), DIALOG_CHAR_CYRILLIC_CAPITAL_I_SHORT);
	curX += gDialogCharWidths[str[strPos]];
	break;
...
case DIALOG_CHAR_CYRILLIC_CAPITAL_IO: // Ё
	...
	print_menu_char(curX, (curY - 8), MENU_CHAR_ACCENT_DIAERESIS);
	curX += gDialogCharWidths[str[strPos]];
	break;
