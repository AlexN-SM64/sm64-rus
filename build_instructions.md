...
5. В результате сборки ваша игра для N64 будет находится там: `build/us/sm64.us.z64`
...
5. В результате сборки ваша игра для Linux будет находится там: `build/us_pc/sm64.us`
