...
### Дистрибутивы Linux, основанные на Debian GNU/Linux
...
2. Перейдите [в раздел](#дистрибутивы-linux-основанные-на-debian-gnulinux) сверху и продолжайте следовать инструкцию по выполнению сборки (шаги 2-7).
...
2. Перейдите [в раздел](#дистрибутивы-linux-основанные-на-debian-gnulinux-1) снизу и продолжайте следовать инструкцию по выполнению сборки.
...
2. Перейдите [в раздел](#дистрибутивы-linux-основанные-на-debian-gnulinux-1) сверху и продолжайте следовать инструкцию по выполнению сборки (шаги 2-7).
