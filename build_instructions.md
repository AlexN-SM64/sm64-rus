...
2. Перейдите [в раздел](#дистрибутивы-linux,-основанные-на-debian-gnu/linux) сверху и продолжайте следовать инструкцию по выполнению сборки (шаги 2-7).
...
2. Перейдите [в раздел](#дистрибутивы-linux,-основанные-на-debian-gnu/linux-1) сверху и продолжайте следовать инструкцию по выполнению сборки (шаги 2-7).
