...
2. Перейдите [в раздел "Выполнение сборки игры для ПК"](https://github.com/AlexN-SM64/sm64-rus#%D0%B2%D1%8B%D0%BF%D0%BE%D0%BB%D0%BD%D0%B5%D0%BD%D0%B8%D0%B5-%D1%81%D0%B1%D0%BE%D1%80%D0%BA%D0%B8-%D0%B8%D0%B3%D1%80%D1%8B-%D0%B4%D0%BB%D1%8F-%D0%BF%D0%BA) сверху и продолжайте следовать инструкцию (необязательно). Потом не забудьте изменить `Makefile` с помощью `tools/apply_patch.sh patch_makefile_rus.patch`.
