...
2. Перейдите [в раздел](https://github.com/AlexN-SM64/sm64-rus?tab=readme-ov-file#linux) сверху и продолжайте следовать инструкцию по выполнению сборки.
...
1. Находите и клонируйте репозиторий, где есть исходный код игры для порта на другую платформу, и следите инструкцию!

2. После выполнения нативной сборки очистите каталог `build`, выполнив `make clean`.

3. Перейдите [в раздел "Выполнение сборки игры для ПК"](https://github.com/AlexN-SM64/sm64-rus#%D0%B2%D1%8B%D0%BF%D0%BE%D0%BB%D0%BD%D0%B5%D0%BD%D0%B8%D0%B5-%D1%81%D0%B1%D0%BE%D1%80%D0%BA%D0%B8-%D0%B8%D0%B3%D1%80%D1%8B-%D0%B4%D0%BB%D1%8F-%D0%BF%D0%BA) сверху и продолжайте следовать инструкцию.
