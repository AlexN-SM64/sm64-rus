...
Super Mario 64 EX (SM64EX) - Русская версия. Мод для https://github.com/sm64pc/sm64ex.
...
Для установки компонентов обратитесь [в SM64EX вики](https://github.com/sm64pc/sm64ex/wiki).
...
4. Обновите код:
```sh
sh update_to_nightly.sh
```
Важно: Перед обновлением кода не забудьте установить компонент `patch`.
