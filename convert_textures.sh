...
for texture in *.$2.png; do
	echo "Конвертирование в $3: $texture -> $4/output.${texture%.$2.png}.$3.inc.c"
	$(popd)/tools/n64graphics -s u8 -i $4/output.${texture%.$2.png}.$3.inc.c -g $texture -f $3
done
popd
